    ...
    public static void main(String[] args) throws Exception {
        ...
        int numberOfCrawlers =
                Integer.parseInt(Config.getInstance().
                        getOrDefault(Constants.CFG_CRAWLERS_NUMBERS, "3").toString());
        ...
        config.setMaxPagesToFetch(Integer.parseInt(Config.getInstance().
                getOrDefault(Constants.CFG_MAX_PAGE_NUM, "1000").toString()));
